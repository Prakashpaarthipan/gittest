...
error_reporting(E_ALL);
	...
	/* $exp_tcs_allbrn = explode(", ",$testObject->extract_connection_brncon($brncode, $brnmode));
		$_SESSION['allbrnusername2'] = $exp_tcs_allbrn[0];
		$_SESSION['allbrnpassword2'] = $exp_tcs_allbrn[1];
		$_SESSION['allbrnhost_db2'] = $exp_tcs_allbrn[2];

...
$where_conditions = 'EMPCODE = 14442';
echo update_query($field_value, $tbl_name, $where_conditions); */
function update_allbrnquery($field_values, $tbl_names, $where_condition,$brncode,$brnmode)
{
	if($_SESSION['dbassign'] == '') {
		include("config_1.php");
	}
	elseif($_SESSION['allbrnusername'] != '' and $_SESSION['allbrnpassword'] != '' and $_SESSION['allbrnhost_db'] != '')  { 
		$connect_db = oci_connect($_SESSION['allbrnusername'], $_SESSION['allbrnpassword'], $_SESSION['allbrnhost_db'], 'AL32UTF8');
	}
...
/* Update All Brn Query Completed */
